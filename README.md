...
#### MacOS/Linux
```
curl -Lo ec2-metadata-mock https://github.com/aws/amazon-ec2-metadata-mock/releases/download/v1.9.2/ec2-metadata-mock-`uname | tr '[:upper:]' '[:lower:]'`-amd64
chmod +x ec2-metadata-mock
```

#### ARM Linux
```
curl -Lo ec2-metadata-mock https://github.com/aws/amazon-ec2-metadata-mock/releases/download/v1.9.2/ec2-metadata-mock-linux-arm
```

```
curl -Lo ec2-metadata-mock https://github.com/aws/amazon-ec2-metadata-mock/releases/download/v1.9.2/ec2-metadata-mock-linux-arm64
```

#### Windows
```
curl -Lo ec2-metadata-mock https://github.com/aws/amazon-ec2-metadata-mock/releases/download/v1.9.2/ec2-metadata-mock-windows-amd64.exe
```

### Install w/ Docker
```
docker pull amazon/amazon-ec2-metadata-mock:v1.9.2
docker run -it --rm -p 1338:1338 amazon/amazon-ec2-metadata-mock:v1.9.2
```
...
#### kubectl
kubectl apply -f https://github.com/aws/amazon-ec2-metadata-mock/releases/download/v1.9.2/all-resources.yaml
