...
```sh
curl -L https://github.com/aws/amazon-ec2-metadata-mock/releases/download/v1.13.0/amazon-ec2-metadata-mock-1.13.0.tgz
```

```sh
helm install amazon-ec2-metadata-mock amazon-ec2-metadata-mock-1.13.0.tgz \
  --namespace default
```
