...
```sh
helm install amazon-ec2-metadata-mock amazon-ec2-metadata-mock-1.5.0.tgz \
  --namespace default
```
...
`aemm.mockIPCount` | number of IPs that can receive spot interrupts and/or scheduled events; subsequent requests will return 404 | `""` | `99`
