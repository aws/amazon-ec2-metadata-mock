...
```sh
curl -L https://github.com/aws/amazon-ec2-metadata-mock/releases/download/v1.9.2/amazon-ec2-metadata-mock-1.9.2.tgz
```

```sh
helm install amazon-ec2-metadata-mock amazon-ec2-metadata-mock-1.9.2.tgz \
  --namespace default
```
