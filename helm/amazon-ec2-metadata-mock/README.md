...
```sh
curl -L https://github.com/aws/amazon-ec2-metadata-mock/releases/download/v1.8.1/amazon-ec2-metadata-mock-1.8.1.tgz
```

```sh
helm install amazon-ec2-metadata-mock amazon-ec2-metadata-mock-1.8.1.tgz \
  --namespace default
```
