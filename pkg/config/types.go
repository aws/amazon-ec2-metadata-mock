...
import (
	autoscaling "github.com/aws/amazon-ec2-metadata-mock/pkg/mock/autoscaling/config"
...
type Config struct {
	...
	AutoscalingConfig autoscaling.Config `mapstructure:"autoscaling"`
...
type Paths struct {
	...
	AutoscalingTargetLifecycleState string `mapstructure:"autoscaling-target-lifecycle-state"`
