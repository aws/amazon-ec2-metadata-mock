...
func newCmd() *cobra.Command {
	...
	cmd.Flags().StringP(noticeTimeFlagName, "r", "", "rebalance notice time specifies the approximate time when the rebalance recommendation notification will be emitted in RFC3339 format")
